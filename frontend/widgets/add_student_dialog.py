...
class AddStudentDialog(QDialog):
        ...
        def _on_bulk_add(self):
            ...
            try:
                # Import the bulk upload dialog
                from bulk_upload_dialog import BulkUploadDialog

                # Pass the UI path if it's in a ui folder
                ui_path = os.path.join(os.path.dirname(__file__), "..", "ui", "bulk_upload_dialog.ui")
                ...
                QMessageBox.warning(
                    self,
                    "Module Not Found",
                    "bulk_upload_dialog.py not found.\n"
